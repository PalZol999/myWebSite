...
const ProjectNative = ({ title, des, src }) => {
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <img src={gitHub} alt="gitHub" onClick={() => openInNewTab('https://github.com/PalZol999/react-native-workout')}/>
